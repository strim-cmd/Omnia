package com.omnia.designsystem.icon
...
/**
 * The Omnia icon set. Path data is derived from the Material Design icon set
 * (Apache 2.0); the icons are re-drawn locally so the foundation does not depend
 * on the deprecated `material-icons` artifacts.
 */
object OmniaIcons {
    ...
    val Chat: ImageVector by lazy {
        vectorIcon(
            name = "Chat",
            pathData = "M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z",
        )
    }

    val Providers: ImageVector by lazy {
        vectorIcon(
            name = "Providers",
            pathData = "M2 20h20v-4H2v4zm2-3h2v2H4v-2zM2 4v4h20V4H2zm4 3H4V5h2v2zm-4 7h20v-4H2v4zm2-3h2v2H4v-2z",
        )
    }
