...
public enum Localized {
    ...
    public static var editProvider: String { String(localized: "edit_provider") }
    ...
    public static var openProviders: String { String(localized: "open_providers") }
    ...
    public static var tryAgain: String { String(localized: "try_again") }
