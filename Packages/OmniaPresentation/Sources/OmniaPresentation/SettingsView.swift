...
public struct SettingsView: View {
    ...
    /// Translates the configure intent with the composed request, the
    ...
    /// Translates the model-edit intent for the connection with the given
    /// list item: the model editor is presented.
    public let onEditModel: (ProviderConnectionListItem) -> Void
    /// Translates the model-update intent for the connection with the given
    /// identity and the updated model.
    ...
    private func connectionRow(_ item: ProviderConnectionListItem) -> some View {
        ...
        .contextMenu {
            ...
            Button {
                ...
                Label(Localized.editModel, systemImage: "textformat")
            }
