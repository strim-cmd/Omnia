...
/// Infrastructure Sprint 2 land: the text generation contract is realized by
/// this stage (DES-010 §3.9.1, PRD-005), and the conversation and streaming
/// contracts return with the stages that follow. It never claims to deliver a
/// capability it cannot deliver yet. Live availability is reported here, by the
...
public struct OpenAICompatibleProviderAdapter: TextGenerationContract, Sendable {
