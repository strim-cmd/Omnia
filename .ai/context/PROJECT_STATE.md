...
next_tasks:
  ...
  - Continue Infrastructure Sprint 2 (milestone #7): the concrete capability surface is frozen (DES-010 v1.1.0, issue #71), the capability mapping is implemented (issue #72), and the text generation, conversation, and streaming capabilities are realized (issues #73, #74, #75); complete the package verification (issue #76) against the frozen §3.9 surface
