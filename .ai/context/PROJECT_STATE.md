...
next_tasks:
  ...
  - Continue Domain Sprint 2 (milestone #5): the capability contract extension is frozen (DES-009 v0.3.0), the capability design is frozen (§3.11, issue #65), and the capability value objects, errors, and concrete contract methods are implemented (issues #66-#68); implement the streaming behavior and verification per PRD-004 (issues #69-#70)
