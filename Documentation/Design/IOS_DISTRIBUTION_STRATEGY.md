...
3. **Unsigned IPA (Third-Party Signing)**: An unsigned IPA generated for use with third-party tools (e.g., Scarlet, ESign). Does not use provisioning profiles.

### Configuration
Export options are defined in:
- `.github/export/ios-appstore.plist`
- `.github/export/ios-adhoc.plist`
- `.github/export/ios-unsigned.plist`
